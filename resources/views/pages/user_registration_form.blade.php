                	...
                	<h4 class="sub-title"><i class="icofont icofont-lock"></i> Authentication</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                {{ Form::select('UserType', ['L' => 'Large', 'S' => 'Small'],null,['class' => 'form-control']) }}
                            </div>

                            <div class="form-group col-md-6">
                                {{ Form::label('UserRole', 'User Role:') }}
                                {{ Form::select('UserRole', ['L' => 'Large', 'S' => 'Small'],null,['class' => 'form-control']) }}
                            </div>
                        </div>

                    <h4 class="sub-title"><i class="icofont icofont-lock"></i> QR Code</h4>
